    ...
    <div className='mt-8 lg:pt-16' id="aboutUs" data-aos="fade-up">
        ...
        <div className=' lg:flex h-auto bg-[#323232]  opacity-100 p-16  md:p-16 pt-16  ' data-aos="">
            ...
            <div className='relative mt-8 lg:w-1/2 '>
                <h6 className=' text-white font-bold text-center md:text-left md:text-[25px] m-2 pb-4 '>I am Channa Maduranga</h6>
                ...
                <div className=' w-full    flex items-center justify-center mt-8 md:justify-end '>
