      ...
      <nav className="bg-black text-white py-4  md:py-2 z-50  w-full  fixed ">
        <div className="  flex justify-between items-center px-2  ">
          ...
          <ul className={`md:flex space-x-6 absolute md:static  bg-black justify-center  md:justify-end pr-8 md:pr-2 transition-all md:text-white duration-300 ease-in ${isOpen ? 'top-12 left-0 w-full opacity-100 pb-8' : 'top-[-500px] w-full left-0 '}`}>
            ...
            <li className="text-center md:text-left"><a href="/channa-maduranga-photography-web/Album" className="block py-2 md:py-0 px-4 md:px-0 underline-animate">Home</a></li><hr className='m-auto' />
