...
function AboutMe() {
  return (
    <div className='mt-8'>
        <div>
            <h2 className="text-2xl  md:text-3xl lg:text-4xl font-bold text-center mb-8">About Me</h2>
        </div>
        <div className='w-full lg:flex h-auto bg-black opacity-100 p-16 md:p8 pt-16  '>
